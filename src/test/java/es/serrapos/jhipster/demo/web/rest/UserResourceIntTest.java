package es.serrapos.jhipster.demo.web.rest;

import es.serrapos.jhipster.demo.JhipsterDemo1App;
import es.serrapos.jhipster.demo.domain.Authority;
import es.serrapos.jhipster.demo.domain.User;
import es.serrapos.jhipster.demo.repository.UserRepository;
import es.serrapos.jhipster.demo.repository.search.UserSearchRepository;
import es.serrapos.jhipster.demo.security.AuthoritiesConstants;
import es.serrapos.jhipster.demo.service.MailService;
import es.serrapos.jhipster.demo.service.UserService;
import es.serrapos.jhipster.demo.service.dto.UserDTO;
import es.serrapos.jhipster.demo.service.mapper.UserMapper;
import es.serrapos.jhipster.demo.web.rest.errors.ExceptionTranslator;
import es.serrapos.jhipster.demo.web.rest.vm.ManagedUserVM;
